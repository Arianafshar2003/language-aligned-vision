# ridge_regression_roberta.py
"""
Voxelwise ridge regression encoding model for RoBERTa PCA features.

Usage:
  python ridge_regression_roberta.py <subject_number> <feature_type>

Example:
  python ridge_regression_roberta.py 1 descriptions
  python ridge_regression_roberta.py 1 adjectives
"""
...
# Feature configuration (input PCA file, output alphas, output predictions)
RIDGE_CONFIG = {
    "descriptions": {
        "input": "features_roberta_base_descriptions_pca.npy",
        "alphas_out": "best_alphas_roberta_descriptions.npy",
        "pred_out": "Y_pred_roberta_descriptions.npy",
    },
    "descriptions_shuffled": {
        "input": "features_roberta_base_descriptions_shuffled_pca.npy",
        "alphas_out": "best_alphas_roberta_descriptions_shuffled.npy",
        "pred_out": "Y_pred_roberta_descriptions_shuffled.npy",
    },
    "bag": {
        "input": "features_roberta_base_bag_pca.npy",
        "alphas_out": "best_alphas_roberta_bag.npy",
        "pred_out": "Y_pred_roberta_bag.npy",
    },
    "bag_shuffled": {
        "input": "features_roberta_base_bag_shuffled_pca.npy",
        "alphas_out": "best_alphas_roberta_bag_shuffled.npy",
        "pred_out": "Y_pred_roberta_bag_shuffled.npy",
    },
    "objects": {
        "input": "features_roberta_base_objects_pca.npy",
        "alphas_out": "best_alphas_roberta_objects.npy",
        "pred_out": "Y_pred_roberta_objects.npy",
    },
    "verbs": {
        "input": "features_roberta_base_verbs_pca.npy",
        "alphas_out": "best_alphas_roberta_verbs.npy",
        "pred_out": "Y_pred_roberta_verbs.npy",
    },
    "adjectives": {
        "input": "features_roberta_base_adjectives_pca.npy",
        "alphas_out": "best_alphas_roberta_adjectives.npy",
        "pred_out": "Y_pred_roberta_adjectives.npy",
    },
}
...
def process_subject(subj, feature_type):
    ...
    if not feature_file.exists():
        ...
        print("   Run pca_roberta.py first.")
        return
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python ridge_regression_roberta.py <subject_number> <feature_type>")
